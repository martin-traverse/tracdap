...
class StructProcessor:
    ...
    def _define_struct_for_dataclass(
            ...
            named_types: _tp.Dict[str, _meta.StructSchema],
        ...
        try:
            ...
            if len(type_stack) == 1:
                return _meta.StructSchema(fields=trac_fields, namedTypes=named_types)
            else:
    ...
    def _define_field(
            ...
            named_types: _tp.Dict[str, _meta.StructSchema], type_stack: _tp.List[str],
