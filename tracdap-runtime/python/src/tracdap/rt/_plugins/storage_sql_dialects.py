...
from tracdap.rt._impl.ext.sql import *


try:
    import sqlalchemy as sqla

    class SqlAlchemyWrapper(ISqlDialect):

        def __init__(self, properties: tp.Dict[str, str]):
            self.__engine = sqla.create_engine("")
        ...
        def connect(self, **kwargs) -> "DbApiWrapper.Connection":
            ...
            return SqlAlchemyWrapper.ConnectionWrapper(self.__engine.connect())
        ...
        class ConnectionWrapper(DbApiWrapper.Connection):
            ...
            def cursor(self) -> "DbApiWrapper.Cursor":
                return SqlAlchemyWrapper.CursorWrapper(self.__conn)
...
try:
    ...
    class SqliteDialect(ISqlDialect):
        ...
        def param_style(self) -> "DbApiWrapper.ParamStyle":
            return DbApiWrapper.ParamStyle.QMARK
