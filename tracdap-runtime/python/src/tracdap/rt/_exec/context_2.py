...
#
#     def get_table(self, dataset_name: str, framework: _eapi._DataFramework[_eapi._DATA_FRAMEWORK], **kwargs) -> _eapi._DATA_FRAMEWORK:  # noqa
#
#         _val.validate_signature(self.get_table, dataset_name, framework, **kwargs)
#         _val.require_package(framework.module_name(), framework.api_type())
#
#         self.__val.check_dataset_valid_identifier(dataset_name)
#         self.__val.check_dataset_defined_in_model(dataset_name)
#         self.__val.check_dataset_available_in_context(dataset_name)
...
#         converter = _data.PandasArrowConverter(**kwargs)  # TODO .for_framework(framework, _pa.Table)
#
#         self.__val.check_context_object_type(dataset_name, data_view, _data.DataView)
#         self.__val.check_dataset_schema_defined(dataset_name, data_view)
...
#
#         return converter.from_internal(table)
#
...
#
#         _val.validate_signature(self.put_table, dataset_name, dataset, **kwargs)
#
#         self.__val.check_dataset_valid_identifier(dataset_name)
...
#         data_view = self.__local_ctx.get(dataset_name)
#         part_key = _data.DataPartKey.for_root()
#         converter = _data.PandasArrowConverter(**kwargs)
#
#         if data_view is None:
#             if static_schema is not None:
#                 data_view = _data.DataView.for_trac_schema(static_schema)
...
#         _val.require_package("pandas", _data.pandas)
#
#         self.put_table(dataset_name, dataset)
#
...
#
#
# # class TracDataStorageImpl(_eapi.TracDataStorage[_eapi._DATA_FRAMEWORK]):
# #
# #     __INTERNAL_API = _tp.TypeVar("__INTERNAL_API")
# #
# #     def __init__(
# #             self, storage_key: str, storage_impl: _storage.IDataStorageBase[__INTERNAL_API],
# #             data_converter: _data.DataConverter[__INTERNAL_API, _DATA_FRAMEWORK],
...
# #
# #     def read_table(self, table_name: str, schema: _tp.Optional[SchemaDefinition] = None) -> _DATA_FRAMEWORK:
# #
...
# #
# #     def native_read_query(self, query: str, **parameters) -> _DATA_FRAMEWORK:
# #
...
# #         return self.__converter.from_internal(raw_data)
# #
# #     def write_table(self, table_name: str, dataset: _DATA_FRAMEWORK):
# #
...
#
#         if not self.__VALID_IDENTIFIER.match(table_name):
...
#
#         if self.__RESERVED_IDENTIFIER.match(table_name):
