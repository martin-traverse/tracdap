...
class TracDataStorage(_tp.Generic[DATA_API]):
    ...
    @_abc.abstractmethod
    def read_table(self, table_name: str, schema: _tp.Optional[SchemaDefinition] = None) -> DATA_API:
        pass
...
class TracDataContext(TracContext):
    ...
    @_abc.abstractmethod
    def get_data_storage(self, storage_key: str, framework: DataFramework[DATA_API]) -> TracDataStorage[DATA_API]:
        pass
