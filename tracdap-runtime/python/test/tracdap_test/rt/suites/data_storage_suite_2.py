...
import tracdap.rt._impl.ext.storage as _storage  # noqa
...
class DataStorageTestSuite:
    ...
    storage: _storage.ISimpleDataStorage
    ...
    def test_round_trip_basic(self):
        ...
        self.storage.write_table("round_trip_basic", table)
        rt_table = self.storage.read_table("round_trip_basic")
    ...
    def test_round_trip_nulls(self):
        ...
        self.storage.write_table("round_trip_nulls", table)
        rt_table = self.storage.read_table("round_trip_nulls")
    ...
    def test_edge_cases_integer(self):
        ...
        self.storage.write_table("edge_cases_integer", table)
        rt_table = self.storage.read_table("edge_cases_integer")
    ...
    def test_edge_cases_float(self):
        ...
        self.storage.write_table("edge_cases_float", table)
        rt_table = self.storage.read_table("edge_cases_float")
    ...
    def test_edge_cases_float_nan(self):
        ...
        self.storage.write_table("edge_cases_float_nan", table)
        rt_table = self.storage.read_table("edge_cases_float_nan")
    ...
    def test_edge_cases_decimal(self):
        ...
        self.storage.write_table("edge_cases_decimal", table)
        rt_table = self.storage.read_table("edge_cases_decimal")
    ...
    def test_edge_cases_string(self):
        ...
        self.storage.write_table("edge_cases_string", table)
        rt_table = self.storage.read_table("edge_cases_string")
    ...
    def test_edge_cases_date(self):
        ...
        self.storage.write_table("edge_cases_date", table)
        rt_table = self.storage.read_table("edge_cases_date")
    ...
    def test_edge_cases_datetime(self):
        ...
        self.storage.write_table("edge_cases_datetime", table)
        rt_table = self.storage.read_table("edge_cases_datetime")
