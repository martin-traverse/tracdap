...
class ImportModelTest(unittest.TestCase):
    ...
    def test_scan_model_ok(self):
        ...
        self.assertEqual(meta.BasicType.STRING, input_table_schema.fields[2].fieldType.basicType)
        ...
        self.assertEqual(True, input_table_schema.fields[2].fieldType.categorical)
        ...
        self.assertEqual(meta.BasicType.FLOAT, output_table_schema.fields[2].fieldType.basicType)
