...
public class CsvDecoder extends BufferDecoder {
    ...
    public CsvDecoder(BufferAllocator arrowAllocator, ArrowSchema arrowSchema) {
    ...
    public void onBuffer(List<ArrowBuf> buffer) {
        ...
        handleErrors(() -> {
            ...
            csvSchema = CsvSchemaMapping
                    .arrowToCsv(arrowSchema.concreteSchema())
                    //.setNullValue("")
                    .build();
            ...
            context = ArrowContext.forSchema(arrowSchema, arrowAllocator);
    ...
    boolean doParse(CsvParser parser, CsvSchema csvSchema, ArrowContext context) throws Exception {
