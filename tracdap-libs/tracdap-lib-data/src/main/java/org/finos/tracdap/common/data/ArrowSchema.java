...
public class ArrowSchema {
    ...
    public ArrowSchema(Schema primarySchema) {
        this.primarySchema = primarySchema;
        this.concreteSchema = primarySchema;
    }

    public ArrowSchema(Schema primarySchema, Schema concreteSchema) {
        this.primarySchema = primarySchema;
        this.concreteSchema = concreteSchema;
    }

    public static ArrowSchema inferConcreteSchema(Schema primarySchema, DictionaryProvider dictionaries) {
        ...
        for (var field : primarySchema.getFields()) {
            if (field.getDictionary() != null) {
                ...
                var concreteField = dictionary.getVector().getField();
        ...
        return new ArrowSchema(primarySchema, new Schema(concreteFields));
    }
    ...
    public static ArrowSchema tracToArrow(SchemaDefinition tracSchema) {
        ...
        return new ArrowSchema(new Schema(arrowFields), concreteSchema);
    }
