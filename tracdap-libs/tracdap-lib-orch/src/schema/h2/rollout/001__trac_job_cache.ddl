...
create table cache_ticket (
    ...
    constraint ticket_fk_entry foreign key (entry_fk) references cache_entry (entry_pk)
);

create unique index cache_ticket_unq_idx on cache_ticket (entry_fk, revision);
