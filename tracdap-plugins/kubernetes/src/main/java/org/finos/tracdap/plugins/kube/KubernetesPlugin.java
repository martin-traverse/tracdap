...
package org.finos.tracdap.plugins.kube;
...
import org.finos.tracdap.plugins.kube.executor.KubernetesBatchExecutor;

import java.util.List;
import java.util.Properties;


public class KubernetesPlugin extends TracPlugin {

    private static final String PLUGIN_NAME = "KUBERNETES";
    private static final String KUBERNETES_EXECUTOR = "KUBERNETES_EXECUTOR";

    private static final List<PluginServiceInfo> serviceInfo = List.of(
            new PluginServiceInfo(IBatchExecutor.class, KUBERNETES_EXECUTOR, List.of("kubernetes")));
